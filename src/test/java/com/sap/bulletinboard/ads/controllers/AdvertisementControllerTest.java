...
public class AdvertisementControllerTest {
    ...
    public void navigatePages() throws Exception {
        ...
        assertThat(linkHeader, is("Link: </api/v1/ads/pages/1>; rel=\"next\""));
        ...
        assertThat(linkHeader2ndPage, is("Link: </api/v1/ads/pages/0>; rel=\"previous\", </api/v1/ads/pages/2>; rel=\"next\""));
        ...
        assertThat(linkHeader3rdPage, is("Link: </api/v1/ads/pages/1>; rel=\"previous\""));
