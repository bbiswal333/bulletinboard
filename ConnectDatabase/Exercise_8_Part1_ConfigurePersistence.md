...
In this exercise we provide the `CloudDatabaseConfig` class, which is required to set up a CRUD repository based on the information provided in the `VCAP_SERVICES` environment variable. 
