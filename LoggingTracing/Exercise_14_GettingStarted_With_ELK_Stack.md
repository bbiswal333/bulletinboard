...
## Step 1.3: Push your Service and create some log messages on CF
...
- Go to Kibana: For Europe (Frankfurt) use [https://logs.cf.eu10.hana.ondemand.com/](https://logs.cf.eu10.hana.ondemand.com/) and for US East (VA) use [https://logs.cf.us10.hana.ondemand.com/](https://logs.cf.us10.hana.ondemand.com/) and login with your CF user, i.e. your email address and password.
